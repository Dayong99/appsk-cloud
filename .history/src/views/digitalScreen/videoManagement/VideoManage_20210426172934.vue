  ...
  methods: {
    ...
    getVideoFullScreen() {
      ...
      for (let i = 0; i < this.newArr.length; i++) {
        ...
        if (typeof this.vedioList != 'undefined' && myPlayer.length != null) {
        ...
        debugger;
        myPlayer.innerHTML =
          "<video id='" + this.newArr[i].videoKey + "' class='video-js vjs-default-skin' controls style='width: 100%; height: 100%' preload='auto'><source :src='" +
          this.newArr[i].video +
