  ...
  methods: {
    ...
    getVideoFullScreen() {
      if (this.newArr.length > 1) {
        ...
        for (let y = 0; y < this.vedioList.length; y++) {
          myPlayer = document.getElementById('my-video' + y).childNodes
        ...
        myVideoDiv.innerHTML =
           "<video class='video-js vjs-default-skin' controls style='width: 100%; height: 100%' preload='auto'><source :src='" + item.video + "' type='application/x-mpegURL' /></video>"
        setTimeout(() => {
