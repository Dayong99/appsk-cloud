      ...
      <a-card :bordered="false">
        ...
        <div class="table-page-search-wrapper">
          ...
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            <a-row :gutter="24">
              <a-col :xl="6" :lg="7" :md="8" :sm="24" v-if="$store.state.user.info.username=='admin'">
                <a-form-item label="租户">
                  <j-dict-select-tag placeholder="请选择租户" v-model="queryParam.relTenantIds" dictCode="sys_tenant,name,id"/>
                </a-form-item>
              </a-col>
              <a-col :md="12" :sm="8">
