    ...
    <div :style="{ width: '100%', border: '1px solid #e9e9e9', padding: '10px 16px', background: '#fff' }">
      <a-spin :spinning="confirmLoading">
        <a-form :form="form">
          ...
          <a-form-item v-show="show" :labelCol="labelCol" :wrapperCol="wrapperCol" label="APP菜单名称">
            <a-input placeholder="请输入APP菜单名称" v-decorator="['appPermissionName', {}]" :readOnly="disableSubmit" />
          </a-form-item>

          <a-form-item v-show="show" :labelCol="labelCol" :wrapperCol="wrapperCol" label="APP菜单路径">
            <a-input placeholder="请输入APP菜单路径" v-decorator="['appUrl', {}]" :readOnly="disableSubmit" />
          </a-form-item>
          
          <a-form-item label="APP菜单图片" :labelCol="labelCol" :wrapperCol="wrapperCol">
            <j-image-upload isMultiple :number="1" v-decorator="['appPic']"></j-image-upload>
          </a-form-item>

          <a-form-item v-show="show" :labelCol="labelCol" :wrapperCol="wrapperCol" label="大屏菜单名称">
            <a-input placeholder="请输入大屏菜单名称" v-decorator="['bigScreenName', {}]" :readOnly="disableSubmit" />
          </a-form-item>

          <a-form-item v-show="show" :labelCol="labelCol" :wrapperCol="wrapperCol" label="大屏菜单路径">
            <a-input placeholder="请输入大屏菜单路径" v-decorator="['bigScreenUrl', {}]" :readOnly="disableSubmit" />
          </a-form-item>
...
export default {
  ...
  computed: {
    validatorRules: function () {
      return {
        ...
        appUrl: { rules: [{ required: true, message: '请输入APP组件!' }] },
  ...
  methods: {
    ...
    onChangeMenuType(e) {
      ...
      this.$nextTick(() => {
        this.form.validateFields(['url', 'component', 'appUrl'], { force: true })
      })
    },
    selectIcons() {
