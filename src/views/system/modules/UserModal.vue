    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <!-- <a-form-item label="职务" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-select-position placeholder="请选择职务1" :multiple="false" v-decorator="['post', {}]"/>
        </a-form-item> -->
        ...
        <a-form-item label="租户分配" :labelCol="labelCol" :wrapperCol="wrapperCol" v-show="!departDisabled">
          <a-select
           ...
           <!-- <a-input :disabled="true" :value="tenantList[this.$store.state.user.info.relTenantIds-1].name"/>  -->
        </a-form-item>
    ...
    methods: {
        ...
        getAction(this.url.queryTenantList).then(res=>{
          if(res.success){
            ...
            if(this.$store.state.user.info.username!='admin'){
              this.hourse=true;
              this.currentTenant = this.tenantList[this.$store.state.user.newValue-1];
            }
          }
        })
      },
      ...
      edit (record) {
       ...
       that.checkedDepartNameString = "";
        ...
        //身份为上级显示负责部门，否则不显示
        // if(this.model.userIdentity=="2"){111
        //     this.identity="2";
        ...
        if(!record.relTenantIds || record.relTenantIds.length==0){
          if(this.$store.state.user.info.username!='admin'){
            this.currentTenant = parseInt(this.$store.state.user.newValue)
          }else{
            this.currentTenant =[]
          }    
        }else{
      ...
      handleSubmit () {
        ...
        this.form.validateFields((err, values) => {
          ...
          //  formData.userIdentity=this.identity;
            ...
            if(this.$store.state.user.info.username!='admin'){
              formData.relTenantIds=this.$store.state.user.newValue
            }
