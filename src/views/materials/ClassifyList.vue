<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <!-- <a-button type="primary" icon="download" @click="handleExportXls('材料管理')">导出</a-button>
    ...
    <classify-modal ref="modalForm" @ok="modalFormOk"></classify-modal>
  </a-card>
</template>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/materials/classify/list",
          delete: "/materials/classify/delete",
          deleteBatch: "/materials/classify/deleteBatch",
          exportXlsUrl: "/materials/classify/exportXls",
          importExcelUrl: "materials/classify/importExcel",
