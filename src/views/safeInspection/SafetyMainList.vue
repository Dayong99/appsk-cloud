      ...
      >
        ...
        <template slot="expandedRowRender" slot-scope="record">
          <a-tabs tabPosition="top">
            <a-tab-pane tab="安全巡检计划" key="planSub" forceRender>
              <safet-sub-sub-table :record="record" :queryCondition="queryCondition" />
            </a-tab-pane>
          </a-tabs>
        </template>
        <!-- 内嵌table区域 end -->
       ...
       <safetSubSubTable-modal ref="modalForm" @ok="modalFormOk"></safetSubSubTable-modal>
    </div>
    <!-- table区域 end -->

    <!-- 表单区域 -->
    <safet-main-modal ref="modalForm" @ok="modalFormOk" />
...
import SafetMainModal from './modules/SafetMainModal'
import SafetSubSubTable from './subTables/SafetSubSubTable'
...
export default {
  ...
  data() {
    return {
      ...
      expandedRowKeys: [],
      url: {
        list: '/sys/planMain/list?orderType=1',
