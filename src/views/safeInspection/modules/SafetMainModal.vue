  ...
  >
    <a-spin :spinning="confirmLoading">
      ...
      <a-tabs v-model="activeKey" @change="handleChangeTabs">
        <a-tab-pane tab="安全巡检计划" :key="refKeys[0]" :forceRender="true">
          <j-editable-table
            :ref="refKeys[0]"
...
export default {
  ...
  methods: {
    ...
    classifyIntoFormData(allValues) {
      ...
      let planMain = Object.assign(main, {orderType:1})
      // console.log(planMain)
      // planMain.planStartTime = planMain.planStartTime ? planMain.planStartTime.format('YYYY-MM-DD') : null
      planMain.planStartTime = planMain.planStartTime ? planMain.planStartTime : null
      return {
        ...planMain, // 展开
