<template>
  <div>
    ...
    <planSubSubTable-modal :tableRowData="tableRowData" ref="modalForm" @ok="modalFormOk"></planSubSubTable-modal>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    skipHiddenDanger(value){
      this.$router.push({path:'/safeInspection/qualityList',query:{dangerId:value.id}});
    } 
  },
}
</script>
